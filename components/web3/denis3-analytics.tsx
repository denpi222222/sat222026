  ...
  return (
    <div className='space-y-6'>
      ...
      <Tabs defaultValue='overview' className='space-y-6'>
        <TabsList className='bg-slate-800/50 p-2 backdrop-blur-sm h-auto flex flex-wrap gap-2'>
          <TabsTrigger value='overview' className='text-base px-5 py-3 data-[state=active]:bg-violet-600'>
            <BarChart3 className='h-5 w-5 mr-2' />
            Overview
          </TabsTrigger>
          <TabsTrigger value='cooldowns' className='text-base px-5 py-3 data-[state=active]:bg-blue-600'>
            <Timer className='h-5 w-5 mr-2' />
            Cooldowns
          </TabsTrigger>
          <TabsTrigger value='activity' className='text-base px-5 py-3 data-[state=active]:bg-green-600'>
            <Activity className='h-5 w-5 mr-2' />
            Activity
          </TabsTrigger>
          <TabsTrigger value='players' className='text-base px-5 py-3 data-[state=active]:bg-purple-600'>
