/**
 * !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 * !! ВНИМАНИЕ! SUBGRAPH НЕ РАБОТАЕТ! denis-2 МЁРТВ! Возвращает "Not found" !!
 * !! Этот хук DEPRECATED и возвращает null.                               !!
 * !! Использует denis-2/v1.0.6 который тоже не работает!                  !!
 * !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 */
'use client';
