...
const GECKO_POOLS = [
  'https://api.geckoterminal.com/api/v2/networks/apechain/pools/0x7493b5d547c6d9f42ca1133dcd39e2472b633efc', // New active pool
...
export async function fetchTokenPriceUsd(addr: string) {
  try {
    ...
    // Return fallback if price is 0, NaN, or undefined
