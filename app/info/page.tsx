...
export default function InfoPage() {
  ...
  // Show watermark for all tabs except NFT Inspector - DISABLED
  // const showWatermark = selectedTab !== 'nft-inspector';
  const showWatermark = false; // Watermark disabled for testing

  return (
    <div
      className='min-h-screen mobile-content-wrapper relative overflow-hidden'
    >
      {/* Full screen gradient background */}
      <div className='fixed inset-0 -z-10 bg-gradient-to-br from-violet-900 via-indigo-900 to-violet-900' />
      ...
      {/* Coming Soon Watermark - DISABLED */}
        ...
        <main>
          ...
          <div className='mt-6'>
            <Tabs value={selectedTab} onValueChange={setSelectedTab}>
              <TabsList
                className={cn(
                  'mb-6 bg-slate-800/50 p-2 backdrop-blur-sm w-full grid',
                  isMobile ? 'grid-cols-2 gap-2' : 'grid-cols-4 gap-3'
                )}
              >
                <TabsTrigger
                  value='nft-inspector'
                  className='bg-blue-600/40 hover:bg-blue-600/60 data-[state=active]:bg-blue-600 data-[state=active]:shadow-lg data-[state=active]:shadow-blue-500/30 text-base px-4 py-3 w-full transition-all duration-300 ease-in-out border border-blue-500/30'
                >
                ...
                <TabsTrigger
                  value='cra-token'
                  className='bg-orange-600/40 hover:bg-orange-600/60 data-[state=active]:bg-orange-600 data-[state=active]:shadow-lg data-[state=active]:shadow-orange-500/30 text-base px-4 py-3 w-full transition-all duration-300 ease-in-out border border-orange-500/30'
                >
                ...
                <TabsTrigger
                  value='denis3'
                  className='bg-cyan-600/40 hover:bg-cyan-600/60 data-[state=active]:bg-cyan-600 data-[state=active]:shadow-lg data-[state=active]:shadow-cyan-500/30 text-base px-4 py-3 w-full transition-all duration-300 ease-in-out border border-cyan-500/30'
                >
                ...
                <TabsTrigger
                  value='system'
                  className='bg-purple-600/40 hover:bg-purple-600/60 data-[state=active]:bg-purple-600 data-[state=active]:shadow-lg data-[state=active]:shadow-purple-500/30 text-base px-4 py-3 w-full transition-all duration-300 ease-in-out border border-purple-500/30'
                >
              ...
              {/* NFT Inspector Tab */}
              <TabsContent value='nft-inspector' className='animate-in fade-in-50 duration-300'>
              ...
              {/* CRAA Token Tab */}
              <TabsContent value='cra-token' className='animate-in fade-in-50 duration-300'>
                <div className='grid grid-cols-1 gap-6'>
                  <CRATokenInfo />
                  {/* Fallback message */}
              ...
              {/* Live Analytics Tab */}
              <TabsContent value='denis3' className='animate-in fade-in-50 duration-300'>
                <Denis3Analytics />
                <div className='mt-8'>
                  <CRABurnAnalytics />
                </div>
